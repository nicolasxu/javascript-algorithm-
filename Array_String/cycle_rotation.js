...
function solution(A, K) {
    ...
    var count = K % arrLength; // rotation count

    var removedArr = A.splice(arrLength - count, count);


    removedArr.concat(A);
    return removedArr.concat(A);

}

var inputArr = [3, 8, 9, 7, 6];
var k = 3;
var result = solution(inputArr, k);
console.log(result);
