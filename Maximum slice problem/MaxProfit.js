...
and sold on day Q, where 0 ≤ P ≤ Q < N, then the profit of 
such transaction is equal to A[Q] − A[P], provided that 
A[Q] ≥ A[P]. Otherwise, the transaction brings loss of 
A[P] − A[Q].

For example, consider the following array A consisting 
of six elements such that:
  ...
  A[4] = 21013
  A[5] = 21367
If a share was bought on day 0 and sold on day 2, a 
loss of 2048 would occur because A[2] − A[0] = 21123 − 23171 = −2048.
...
function solution(A) {
	...
	for(var i = 0; i < length; i++) {
		...
		var thisProfit = A[i] -  lowestPrice;
		if(thisProfit > max) {
			max = thisProfit;
		}
	}
...
var inputA = [23171, 21011, 21123, 21366, 21013, 21367];
